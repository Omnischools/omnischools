...
function allRenderedCopy(): string[] {
  const out: string[] = [
    ...
    heroHeadline({ childFirst: "Yaa", missedCount: 3, filedTime: "Wed 14 May", acknowledged: true, makeUpCentre: "Sefwi-Wiawso", nextPaperName: "Mathematics", nextPaperDate: "Wed 3 Jun" }),
    ...
    heroBody({ childFirst: "Yaa", missedCount: 3, filedTime: "Wed 14 May", acknowledged: true, makeUpCentre: "Sefwi-Wiawso", nextPaperName: "Mathematics", nextPaperDate: "Wed 3 Jun" }),
