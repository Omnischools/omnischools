"use client";
/**
 * PRESERVED REFERENCE — the full multi-step onboarding wizard (School identity ·
 * School type · Academic calendar · Academic structure · Staff & roles · Billing &
 * payments · SHS Residency · WAEC). The live /start flow was slimmed to two steps
 * (type → identity); this file is kept intact so its step components (calendar picker,
 * classes/subjects builder, staff/roles, fee-structure, SHS steps) can be reused in the
 * super-admin tenant-setup portal. NOT routed anywhere in the app.
 */
...
export function FullOnboardingWizard() {
