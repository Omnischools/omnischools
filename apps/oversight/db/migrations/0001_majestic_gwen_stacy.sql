...
CREATE INDEX "fact_infrastructure_jurisdiction_period_idx" ON "fact_infrastructure" USING btree ("jurisdiction_id","period_id");--> statement-breakpoint
CREATE INDEX "fact_plc_participation_jurisdiction_period_idx" ON "fact_plc_participation" USING btree ("jurisdiction_id","period_id");--> statement-breakpoint
CREATE INDEX "fact_teacher_attendance_jurisdiction_period_idx" ON "fact_teacher_attendance" USING btree ("jurisdiction_id","period_id");